...
<?php include('../includes/header.php'); ?>
    ...
    <div class="container">
                ...
                <div class="subforum-title" style="display: flex;align-items: center;">
                        ...
                        <div style="padding-left: 55%;margin-top: 1%;"><button class="create--course create--btn add--student" id="btnAddGenDiscussion"><i class="fa-solid fa-plus"></i> Group Discussion</button></div>
                    </div>
                    <?php
