         ...
         <?php
            if(isset($_GET['id'])){
                ...
                $gme_id = $_GET['GMEId'];
                        ...
                        $query = "SELECT f.file_id,f.file_name,f.file_permission,f.file_date,g.entity_name, (SELECT user_fullname from Users_tbl where user_id=f.user_id) as user_name FROM File_tbl f inner join GroupMarked_tbl g on g.GME_id =f.GME_id where f.group_id='$group_id' and f.GME_id='$gme_id' order by file_id desc";
