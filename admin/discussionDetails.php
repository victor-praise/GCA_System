         ...
         <?php
            if(isset($_GET['id'])){
                $post_id = $_GET['id'];
                        ...
                        ?>
         <a href="discussion.php" class="back--link"><i class="fa-solid fa-arrow-left-long"></i> Back</a>
         <div class="container">
            <div class="subforum">
               ...
               <div class="subforum-row">
                  ...
                  <!-- <div class="subforum-stats  subforum-column center">
                     ...
                     <?php 
                        ...
                        $query1 = "SELECT r.*,(SELECT user_name from Users_tbl where user_id=r.user_id) as user_name FROM DiscussionReply_tbl r where r.post_id='$reply_post_id' order by r.reply_date desc limit 1";        
            ...
            <div class="discussions" style="display:block !important">
               ...
               <!-- <div class="back--link" style="float:right;padding-right:5%" > <a href="viewAllFiles.php?id=<?=$_GET['id']?>&GMEId=&Grp=">
            View All Files
        </a></div> -->
               <br>
               <?php
