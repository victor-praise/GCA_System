      ...
      <div class="container">
         <div class="subforum">
            ...
            <?php
               ...
               $query = "SELECT distinct * from DiscussionPagesPost_tbl where gme_id IS NOT NULL and group_id IS NOT NULL and course_id='$courseId' order by post_date, post_time desc";
